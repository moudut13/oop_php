...
<?php include_once "autoload.php"?>
    ...
    if (isset($_POST['submit'])){
         ...
         * Move File
         */
        $photo_name = move($photo,'staff');

        /*
         * Insert Staff
         */
        $staff->InsertStaff($name,$email,$uname,$cell,$photo_name);
    }
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><img src="assets/media/staff/<?php echo $row->photo;?>" alt=""></td>
							<td>
								<a class="btn btn-sm btn-info" href="view.php?staff_id=<?php echo $row->id;?>">View</a>
								<a class="btn btn-sm btn-warning" href="edit.php?staff_id=<?php echo $row->id;?>">Edit</a>
